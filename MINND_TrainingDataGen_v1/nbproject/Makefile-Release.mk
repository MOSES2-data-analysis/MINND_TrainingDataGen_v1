...
${OBJECTDIR}/fomod.o: fomod.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/fomod.o fomod.c

${OBJECTDIR}/gnuplot_i.o: gnuplot_i.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/gnuplot_i.o gnuplot_i.c

${OBJECTDIR}/lmbd_convert.o: lmbd_convert.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -std=c11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/lmbd_convert.o lmbd_convert.c
